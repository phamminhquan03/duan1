                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="#" method="POST" class="space-y-4 md:space-y-6">
                        ...
                        <div class="flex items-center">
                            <input id="type" type="checkbox" name="type" value="1" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800">
                            <label for="type" class="ml-2 text-sm font-medium text-gray-900 dark:text-white">User</label>
                        </div>
